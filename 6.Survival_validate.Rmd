---
title: "Regularized Cox Regression Model Validation"
...
glimpse(data_all)
```
Loading Cox results prepared by Fin group.

```{r load cva-objects}
load("./datain/21Cox-Reg1-saveFin1.Rdata") # `cva_pfit1` 
load("./datain/21Cox-Reg1-saveFin2.Rdata") # `cva_pfit2`
```
